          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-extrabold leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-6xl">
                A smarter way to{" "}
                <span className="text-[#3b82f6]">connect and grow.</span>
              </h1>
              ...
              >
                <Link
                  ...
                  className="min-h-12 items-center justify-center rounded-lg bg-[#0b5ed7] px-6 text-sm font-bold text-white shadow-lg shadow-blue-500/20 transition-all duration-200 hover:bg-[#083b8a] active:scale-95"
                >
                  Get Started
                </Link>
                ...
                <Link
                  ...
                  className="min-h-12 items-center justify-center rounded-lg border border-slate-700 bg-slate-900/60 px-6 text-sm font-bold text-white backdrop-blur-sm transition-all duration-200 hover:border-blue-400 hover:bg-slate-800 active:scale-95"
                >
                  Learn More
                </Link>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 text-xl font-extrabold tracking-tight text-slate-950 sm:text-3xl sm:leading-tight">
                A secure, verified platform designed with your protection and
                success in mind.
              </h2>

              <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">
                We're building SUBSELL around absolute clarity, robust anti-scam
                safeguards, fast automated payouts, and a straightforward
                experience that puts every user first.
              </p>
