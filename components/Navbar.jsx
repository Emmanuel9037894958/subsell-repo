...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-md transition-all duration-300">
      ...
      {/* Animated Roll Down Mobile Menu */}
      <div
      ...
      >
        <div className="overflow-hidden bg-white/95 backdrop-blur-md">
          <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6">
            ...
            {/* Single Column Mobile Nav Links */}
            ...
            <div className="mt-5 pt-5 border-t border-slate-100 grid grid-cols-2 gap-3">
              ...
              <Link
                href="/signup"
                onClick={() => setMenuOpen(false)}
                className="flex items-center justify-center rounded-xl bg-[#0b5ed7] px-4 py-3 text-sm font-bold text-white shadow-md shadow-blue-500/20 transition-all active:scale-95"
              >
                Sign Up
              </Link>
            </div>
